<template>
    <div>
        ...
        <div id="order-now" class="container pb-5">
            <div class="row h-100 py-5">
                ...
                <div
                    class="col-4 offset-1 d-flex flex-column justify-content-center"
                >
