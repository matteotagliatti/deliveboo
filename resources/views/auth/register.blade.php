                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="business-name" type="text" class="form-control @error('business-name') is-invalid @enderror" name="business-name" value="{{ old('business-name') }}" required autocomplete="business-name" autofocus>
